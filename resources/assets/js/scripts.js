(function($) {
    ...
    function preloadShow() {
        ...
        $('body').append('<div class="preloader"><div class="top"></div><div class="bottom"></div><div class="logo">' + ("undefined" === typeof $('body').attr('data-preloadable-logo') ? 'Logo' : $('body').attr('data-preloadable-logo')) );
